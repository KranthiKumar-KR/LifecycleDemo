...
public abstract class TestClass {
    ...
    // abstract classes can have both abstract methods and solid methods (methods with definitions)
    // to make any method or member an abstract member we need add 'abstract' keyword in the method signature
    // we use extends keyword to inherit an abstract class, where as we use implements keyword to inherit an interface
    public abstract int sum();
    public int sumtwonums() {
        return 2;
    }

    public final int sumthree(int n1, int n2, int n3) {
        return n1+n2+n3;
    }

    /**
     * difference between interface v/s abstract
